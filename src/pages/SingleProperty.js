          ...
          <div class="container">
            <div>
              ...
              <div class="safety-module2">
                ...
                PropertyPro.ng. PropertyPro.ng will not mandate agents to ask
                for fees upfront.
              </div>
              <div class="key-features">
                ...
                <p>
                  6 bedroom Detached Duplex for sale Ikoyi Ikoyi Lagos selling
                  for $5,000,000. See property details on PropertyPro.ng or
                  browse all our range of properties in Ikoyi, Lagos
                </p>
                <p>SEAMLESS TRANSACTIONS ONLY</p>
                <p>
                  {" "}
                  DIRECT CASH READY CLIENTS ONLY NEWLY BUILT FULLY DETACHED 6
                  BEDROOM HOUSE + SWIMMING POOL + CINEMA + ELEVATOR + ETC IN
                  IKOYI LAGOS
                </p>
                <p> Price: $5M</p>
                <p>
                ...
                Propertypro only serves as a medium for the advertisement of
                this property. Propertypro.ng is only communicating this
                property offer and is not responsible for selling the property.
                PropertyPro.ng neither warrants nor is making any
                representations with respect to properties or offers listed on
                the site.
              </div>
            </div>
          </div>
